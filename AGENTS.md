...
Class Report — web app for coaches to fill per-student attendance (2 sessions) and remarks (assessment, right behavior, notes) per lesson plan, with a weekly class overview and admin reporting.
